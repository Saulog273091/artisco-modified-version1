...
<html>
  ...
  <!-- </div> -->
      ...
      <form action="RegisterCustomer.php" method="post">
              ...
              <div class="registerareacustomer"
              ...
              <div class="createpassfrm">
                ...
                <input type="checkbox" class="check-box" Password>
              ...
              <div class="middlenameframe">
                <input type="text" placeholder=" " id="middleName" name="middleName">
              ...
              <div class="lastnameframe">
                ...
                <div class="lastnameinput"></div>
              </div>
              <!--LOWERPART SA REGISTER-->
